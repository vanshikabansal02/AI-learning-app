...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return (
    <div className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-emerald-500/10 flex flex-col justify-between" 
        ...
        <div className="mt-6 pt-4 border-t border-slate-100">
          ...
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              <Sparkles className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700" strokeWidth={2.5} />
              Study Now
            </span>
          </button>
        </div>
