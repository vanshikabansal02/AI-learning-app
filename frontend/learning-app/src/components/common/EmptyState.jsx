...
const EmptyState = ({onActionClick, title, description, buttonText}) => {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center bg-linear-t-br from-slate-50/50 to-whote border-2 border-dashed border-slate-200 rounded-3xl">
