          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <p className="w-full h-9 pl-9 pr-3 pt-2 border border-neutral-200 rounded-lg bg-neutral-50 text-neutral-900">
                  {username}
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-1">
                Sign out of your Learnova account.
              </p>
            </div>

            <button
              onClick={handleLogout}
              className="flex items-center justify-center gap-2 px-5 py-2.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition"
            >
