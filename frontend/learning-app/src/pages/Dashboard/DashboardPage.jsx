...
<div className="bg-white/80 bakdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
  ...
  {dashboardData.recentActivity && (dashboardData.recentActivity.documents.length>0||dashboardData.recentActivity.quizzes.length>0)?(
    <div className="space-y-3">
      ...
      .map((activity,index)=>(
        ...
        className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-75"
        >
