    ...
    <div className="max-w-4xl mx-auto">
      ...
      {currentQuestionIndex === quiz.questions.length - 1 ? (
        ...
        <Button
          ...
          disabled={submitting}
          className="group relative px-8 h-12 bg-slate-800 hover:bg-slate-900 text-white font-semibold text-sm rounded-xl transition-all duration-200 active:scale-95 flex items-center gap-2"
        >
          Next
